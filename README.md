...
אפליקציית אלפון דיגיטלי מודרנית בעברית עם ולידציה למספרי טלפון ישראליים.

## ✨ תכונות

- **ולידציה ישראלית**: בדיקת מספרי טלפון ישראליים תקינים
- **עיצוב RTL**: מותאם לעברית (ימין לשמאל)
- **ניהול אנשי קשר**: הוספה, עריכה, מחיקה
- **מערכת מועדפים**: סימון אנשי קשר חשובים
- **חיפוש וסינון**: חיפוש מהיר וסינון לפי מועדפים
- **עיצוב רספונסיבי**: מותאם לכל המכשירים
- **Favicon מותאם**: אייקון ייחודי לטאב הדפדפן
